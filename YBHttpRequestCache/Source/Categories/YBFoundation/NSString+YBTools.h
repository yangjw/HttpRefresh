 ...
 *  @return 编码字符串
 */
- (NSString *)yb_URLEncode;
- (NSString *)yb_URLEncodeUsingEncoding:(NSStringEncoding)encoding;
 ...
 *  @return 解码字符串
 */
- (NSString *)yb_URLDecode;
- (NSString *)yb_URLDecodeUsingEncoding:(NSStringEncoding)encoding;
...
- (NSMutableAttributedString *)yb_attributeAttrs:(NSDictionary *)dic;

- (CGSize)yb_getStringSize:(CGSize)size attrs:(NSDictionary *)dic;

- (CGFloat)yb_getWidthAttributesSize:(CGSize)size attrs:(NSDictionary *)dic;

- (CGFloat)yb_getHeightAttributesSize:(CGSize)size attrs:(NSDictionary *)dic;

- (CGSize)yb_getAttributesStringSize:(CGSize)size attrs:(NSMutableAttributedString *)attrs;

/** 获取一行文本的高度  */
- (CGFloat)yb_getLineAttributedStringHeight:(NSMutableAttributedString *)str;

/** 获取一行文本的高度  */
- (CGFloat)yb_getLineStringHeightWithattrs:(NSDictionary *)dic;

- (CGFloat)yb_getLineHeightWithattrs:(NSDictionary *)dic;
